...
const showPokemon = (pokemon) => {
    $('#pokedex').append(`
    <div class="card col-lg-3 col-md-6 col-sm-6 col-xs-6">
        <div class="card-body">
            <h5 class="card-title">${pokemon.name}</h5>
            <img src="" id="img_${pokemon.name}" class="w-100">
            <button class="btn btnGetDataPokemon mt-3" data-url-pokemon="${pokemon.url}">¡Quiero saber más de este Pokémon! <img src="rsz_super_ball.png" alt="superball" width="22"></button>
        </div>
    </div>
    `);
